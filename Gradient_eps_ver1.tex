...
%We wish to isolate the effects of wave propagation originated in the layer structure. While proper determination of a boundary condition at $z \rightarrow-\infty$ is sufficient for an analytic formulation of such a problem, we want to have numerical simulation ability well. A numerical artefact of reflection from the artificially-defined numerical boundary is avoided by defining a one-sided, right travelling wave at $z=L$.
